...
export default class Scope {
  ...
  _reactRepr = () => (
    <div>
      <div className='idev-padding' style={{fontSize: '2rem'}}>
        <div className='idev-scope-'>
          <Icon name='cube' />
        </div>
      </div>
      <div className='idev-scope idev-padding-top-bottom'>
        {this.objs.filter(obj => obj[1].hidden).keySeq().sort().map(k => (
          <div className='idev-scope-hidden-obj' key={k}
