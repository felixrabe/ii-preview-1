...
export default class CommandLine extends React.Component {
  ...
  loadHistory = () => {
    this.cmdHistory = Object.assign(new CommandHistory(), JSON.parse(localStorage.getItem('history')))
  }

  saveHistory = () => {
    setTimeout(() => localStorage.setItem('history', JSON.stringify(this.cmdHistory)))
  }
