...
export default class Obj extends React.Component {
  ...
  renderHeader() {
    return (
      <div className='idev-obj-header idev-draggable'>
        <div className='idev-obj-header-item'>
          {this.props.name}
        </div>
        <div className='idev-obj-header-space' />
        { this.props.cfg.canHide && (
          <div className='idev-obj-header-item'>
            <span className='idev-obj-command idev-not-draggable'
  ...
  renderBody = () => {
    ...
    if (isValidElement(child)) {
      ...
      child = (
        <div className='idev-padding idev-repr'>Opaque {typeof child}</div>
      )
    }

    return (
      <div className='idev-obj-body'>
        {child}
      </div>
    )
  }
  ...
  render() {
    ...
    props.className = className + ' idev-obj'
